...
func usage(w io.Writer) {
	...
	fmt.Fprintln(w, "  --cli-path <path>   Use the user-specified Snyk CLI at <path> (skip Node/npm/nvm)")
	fmt.Fprintln(w, "                      If omitted, the installer uses PATH or asks to manage Snyk via npm")
	fmt.Fprintln(w, "")
