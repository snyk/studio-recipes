...
WORKFLOW:
  1. post_write_code -> track modified line ranges, launch background scan
  2. post_mcp_tool_use -> wait for scan, filter results to modified lines, block if new vulns

INSTALLATION:
  1. Copy this script and lib/ to .windsurf/hooks/
